...
object DetectorFactory {
    ...
    val backend = Backend.MEDIAPIPE        // working default (GPU). YOLO_QNN_EP = int8 on Hexagon NPU via ORT QNN EP w/ on-device HTP compile (session created OK on AR1; inference latency pending live measurement).
